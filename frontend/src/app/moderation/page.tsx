...
function ModerationView() {
  ...
  useEffect(() => {
    ...
    const sseBaseUrl = process.env.NEXT_PUBLIC_API_URL || "http://localhost:8080/api";
    const eventSource = new EventSource(`${sseBaseUrl}/moderation/stream?access_token=${token}`);
